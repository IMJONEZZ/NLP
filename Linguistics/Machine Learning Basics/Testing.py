...
# print("Age: ",test_df['Age'].isnull().sum())
# print("Pclass: ",test_df['Pclass'].isnull().sum())
# print("SibSp: ",test_df['SibSp'].isnull().sum())
# print("Parch: ",test_df['Parch'].isnull().sum())
# print("Fare: ",test_df['Fare'].isnull().sum())
# print("Sex: ",test_df['Sex'].isnull().sum())
# print("Embarked: ",test_df['Embarked'].isnull().sum())
